...
class TextConvLSTM():
    ...
    def ConvLSTM_model(self):
        ...
        x_title = Bidirectional(ConvLSTM2D(128, kernel_size=5, strides=1, padding='valid',data_format='channels_last',input_shape=(self.title_len, self.seq_len, 1),dropout=0.25), merge_mode='concat')(x_title)
        ...
        x_content = Bidirectional(ConvLSTM2D(128, kernel_size=5, strides=1, padding='valid',data_format='channels_last',input_shape=(self.content_len, self.seq_len, 1),dropout=0.25), merge_mode='concat')(x_content)
