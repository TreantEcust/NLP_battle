...
class TextCNNK2():
    ...
    def CNNK2_model(self):
        ...
        x_title1 = Conv1D(128, 4, strides=1, padding='valid',input_shape=(self.title_len, self.seq_len))(x_title)
        x_title1 = BatchNormalization()(x_title1)
        x_title1 = Activation('relu')(x_title1)
        x_title1 = KMaxPooling.KMaxPooling(k=2)(x_title1)

        x_title2 = Conv1D(128, 3, strides=1, padding='valid',input_shape=(self.title_len, self.seq_len))(x_title)
        x_title2 = BatchNormalization()(x_title2)
        x_title2 = Activation('relu')(x_title2)
        x_title2 = KMaxPooling.KMaxPooling(k=2)(x_title2)

        x_title3 = Conv1D(128, 2, strides=1, padding='valid',input_shape=(self.title_len, self.seq_len))(x_title)
        ...
        x_content1 = Conv1D(256, 5, strides=1, padding='valid',input_shape=(self.content_len, self.seq_len))(x_content)
        ...
        x_content2 = Conv1D(256, 4, strides=1, padding='valid',input_shape=(self.content_len, self.seq_len))(x_content)
        ...
        x_content3 = Conv1D(256, 3, strides=1, padding='valid',input_shape=(self.content_len, self.seq_len))(x_content)
        ...
        x_content4 = Conv1D(256, 2, strides=1, padding='valid', input_shape=(self.content_len, self.seq_len))(x_content)
