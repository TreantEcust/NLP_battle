...
class TextRNN():
    ...
    def RNN_model(self):
        ...
        x_title = Bidirectional(LSTM(256, return_sequences=True), merge_mode='concat')(x_title)
        ...
        x_content = Bidirectional(LSTM(256, return_sequences=True), merge_mode='concat')(x_content)
